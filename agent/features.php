                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class=" d-flex justify-content-between">
                                        <h3 style="margin-top:20px;margin-left:20px"  class="card-title">Features</h3>
                                        <button  style="margin-top:20px;margin-right:20px" class="btn btn-success add-feature">Add Feature</button>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
...
<script>
 ...
 jQuery(document).on('click', '.store-feature', function(event) {
    ...
    axios.post('http://127.0.0.1:8000/api/feature', formData, {
                ...
                {
                    swal({
                    title: "Feature Added Successful !",
    ...
    axios.post('http://127.0.0.1:8000/api/feature/'+$('#feature-id').val()+"/update", formData, {
      ...
      {  targets: 3,
         render: function (data, type, row, meta) {
            return '<button class="btn btn-primary btn-small edit-feature" data-id="'+data+'" data-title="'+row.title+'" data-description="'+row.description+'">Edit</button> <button class="btn btn-danger btn-small" onClick="deleteFeature('+data+')">Delete</button>';
         }
